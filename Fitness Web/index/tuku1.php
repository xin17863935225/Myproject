...
<head>
<meta charset="UTF-8"> 
<title>全球最性感女军人Howard，扛过枪，放过炮，健身后成火辣模特</title>
<style type="text/css">
	*{
			margin: 0;
			padding: 0;
    ...
    <div class="head-logo">
        ...
        <?php
					...
					if(isset($_SESSION['MM_Username'])){
						...
						fwrite($file1, $_SESSION['MM_Username']."进入图库1！<br>\n");
					}else{
						echo'';
					}
					?>
...
<div class="title">
            <span class="t1">全球最性感女军人Howard，扛过枪，放过炮，健身后成火辣模特</span>
        </div>
<div class="banner">
	<ul></ul>
	<ol></ol>

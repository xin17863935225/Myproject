...
<html lang="zh">
	<head>
		<meta charset="UTF-8">
		<title>唐亚男 Alex Tang肌肉照、微博健身网红alextang888健身肌肉图片</title>
...
.head-logo3 {
	...
	<body>
			...
			<div class="head-logo">
				...
				$user -> login_signup_subcatalog1();
					if(isset($_SESSION['MM_Username'])){
						...
						fwrite($file1, $_SESSION['MM_Username']."进入图库3！<br>\n");
					}else{
						echo'';
					}
				?>
		...
		<div class="title">
			<span class="t1">唐亚男 Alex Tang肌肉照、微博健身网红alextang888健身肌肉图片</span>
		</div>
		<div class="banner">
			<ul></ul>
			<ol></ol>
		...
		<script type="text/javascript">$(function() { //页面加载完毕才执行
